...
//   const renderPaySlip = () => (<div className="border content__container1 mb-5 blue-border">
...
function PaymentReceipt() {
  ...
  const renderPaySlip = () => (
    <div className="border content__container1 mb-5 blue-border image-container">
      ...
      <div className="key-value-container">
        <div className="row p-3" style={{ marginLeft: window.innerWidth >= 1200 ? "60px" : "0px" }}>
          <div className="col-6">
            {/* Key-Value Pairs */}
            <div className="d-flex align-items-center mb-2">
              <h6 className="key-col col-6">
