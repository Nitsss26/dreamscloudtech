      ...
      <Table className={classes.table} aria-label="custom pagination table">
        <TableHead>
          <TableRow>
            {tableHeader &&
              tableHeader.map((head) => (
                <TableCell align="left" key={head.id} className={classes.headerCell}>
                  {head.name}
                </TableCell>
              ))}
            ...
            <>
              {(rowsPerPage > 0
                ...
                <TableRow key={row?.id} className={classes.tableRow}>
                  <TableCell style={{ width: 250 }} align="left" className={classes.tableCell}>
                    {row?.name}
                  </TableCell>
                  <TableCell align="left" style={{ width: 250 }} className={classes.tableCell}>
